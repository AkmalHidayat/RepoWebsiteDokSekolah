...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2022 at 11:32 AM
...
CREATE TABLE `documents` (
  ...
  `kategori` enum('Jadwal','Tata Tertib','Prosedur','Data Siswa Baru','Kurikulum','Penilaian') NOT NULL,
...
CREATE TABLE `inmails` (
  `no` varchar(50) NOT NULL,
  `kategori` enum('Persetujuan','Undangan','Permohonan','Pemberitahuan','Perintah') NOT NULL,
